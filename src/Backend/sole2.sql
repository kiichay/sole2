...
VALUES
    ('SH000001', 'Running Shoes', 'Comfortable running shoes for long-distance jogging.', 59.99, 'Shoes', '8, 9, 10, 11', 'Red', 50, 'Mesh', './img/sandal1.png', 'Active', 3.5, 100, 'Kids', 'Color: Red, Size: Custom', 49.99, 10.00, 10, 'Mesh, Rubber', 'Running', '["./img/sandal1.png", "./img/sandal2.png"]'),
    ('SH000002', 'Leather Boots', 'Stylish leather boots with great durability for cold weather.', 89.99, 'Boots', '6, 7, 8, 9', 'Black', 30, 'Leather', './img/sandal2.png', 'Active', 3.5, 500, 'Women', 'Color: Black, Size: Custom', null, 12.50, 8, 'Leather, Rubber', 'Casual', '["./img/sandal2.png", "./img/sandal3.png"]'),
    ('SH000003', 'Summer Sandals', 'Breathable sandals for hot summer days, perfect for beach walks.', 29.99, 'Sandal', '7, 8, 9, 10', 'Blue', 100, 'Plastic', './img/sandal3.png', 'Active', 4.4, 200, 'Kids', 'Color: Blue, Size: Custom', 24.99, 16.67, 20, 'Plastic', 'Casual', '["./img/sandal3.png", "./img/sandal4.png"]'),
    ...
    ('SH000006', 'Winter Boots', 'Durable winter boots with insulation for harsh cold weather.', 120.99, 'Boots', '8, 9, 10', 'Brown', 40, 'Wool', './img/sandal6.png', 'Active', 5.0, 90, 'Kids', 'Color: Brown, Size: Custom', null, 8.25, 12, 'Wool, Rubber', 'Casual', '["./img/sandal6.png", "./img/sandal2.png"]'),
    ('SH000007', 'Slip-On Shoes', 'Easy-to-wear slip-on shoes for casual outings.', 39.99, 'Slippers', '6, 7, 8, 9, 10', 'Gray', 60, 'Canvas', './img/sandal5.png', 'Active', 4.4, 150, 'Women', 'Color: Gray, Size: Custom', 34.99, 12.50, 18, 'Canvas, Rubber', 'Casual', '["./img/sandal1.png", "./img/sandal3.png"]'),
    ...
    ('SH000012', 'Boat Shoes', 'Classic boat shoes perfect for casual outings.', 85.00, 'Shoes', '7, 8, 9, 10', 'Navy', 20, 'Leather', './img/boatshoes.jpg', 'Active', 3.9, 30, 'Women', 'Color: Navy, Size: Custom', null, 0, 5, 'Leather, Rubber', 'Casual', '["./img/boatshoes.jpg"]'),
